...
const About = () => {
    return (
        <div id='about' className='w-full md:h-auto p-2 flex items-center py-10 md:mb-24'>
            <div className='max-w-[1050px] m-auto md:grid grid-cols-3 gap-8'>
                <div className='col-span-2'>
                    <p className='uppercase text-xl tracking-widest text-[#1CC5DC]'>
                        About
                    </p>
